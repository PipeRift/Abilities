...
class FAbilitySpec_StructContainer : public Automatron::FTestSpec
{
	GENERATE_SPEC(FAbilitySpec_StructContainer, "Abilities.StructContainer",
	...
	FAbilitySpec_StructContainer()
	{
		bUseWorld = false;
	}
};

void FAbilitySpec_StructContainer::Define()
{
	BeforeEach([this]() {
		Container = {};
		One = {};
